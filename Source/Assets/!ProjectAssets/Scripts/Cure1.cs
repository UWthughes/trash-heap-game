...
public class Cure1 : Ability//: MonoBehaviour
{
    protected float cooldown = 0f;
    protected float readyAt = 0f;
    protected string description = "+10 HP";
    ...
    {
        set { Description = "Cure1 increases Hit Points by 10."; }
        get { return description; }
    }
    public void OnActivate()
    {
       
        if (owner.HealthPoints + 10 > 99) owner.healthPoints = 100;
        else owner.healthPoints += 10;
        OnDequip(owner);
    }
