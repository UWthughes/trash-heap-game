...
Before you turn in a project, be sure to modify this file!  It should give me a good
description of the files and folders that you want me to look.  For example, if your
code is in Java, you may describe the most important Java packages and the order in
which I should view them to understand your code.
